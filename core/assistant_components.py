...
def _should_delegate_to_agent(text: str) -> bool:
    """Return True for natural multi-step requests that need the agent runtime."""
    ...
    return any(marker in low for marker in compound_markers + action_markers)
...
class CommandProcessor:
    ...
    def process(self, text):
        ...
        # Route natural multi-step/browser/coding requests to the autonomous
        # bridge before legacy regex intents consume the first clause.
