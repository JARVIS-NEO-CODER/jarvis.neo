...
def extract_components(source):
    ...
    # The component file is generated in CI from the exact historical class bodies.
    # It is created by the extraction pass already present in this repository.
...
def main():
    source=SOURCE.read_text(encoding="utf-8"); changed=False
    ...
    print("Assistant modularization pass completed" if changed else "Assistant modularization already applied")
